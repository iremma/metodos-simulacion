...
def get_neighbor(state):
	...
	Tras la optimización de la simulación mediante el recocido simulado obtenemos las gráficas de rendimiento de la Figura \ref{result-graphs}, que representan la evolución de los valores de diferentes parámetros y funciones durante la simulación. \hl{CAMBIAR POR LAS BUENAS!!!}
	...
	Es también interesante señalar la variación de los factores de evolución, ya que los niveles máximos de producto 1 y 2 varían durante la primera mitad de la ejecución, pero se mantienen constantes durante la segunda, teniendo una muy ligera pendiente positiva. 
	...
	\begin{figure}[H]
		...
		\begin{subfigure}{.45\textwidth}
			\centering
			\includegraphics[width=\textwidth]{include/parada/300/factores_decision.png}
			\caption{Evolución de los factores de decisión. }
		\end{subfigure}
		\hfill
		\begin{subfigure}{.45\textwidth}
		\end{subfigure}
